...
Add-Content -Path C:\salt\conf\minion.d\minion.conf -Value "  app: mis"
Add-Content -Path C:\salt\conf\minion.d\minion.conf -Value "  role: db"
Add-Content -Path C:\salt\conf\minion.d\minion.conf -Value "  environment: dev"
